...
if ($busca == '') {
	...
	// codigo que sera executado ser o usuario não estiver pesquisando
	$sql_2 = "SELECT id_usuario, nome, email FROM usuarios 
	...
	// codigo que sera executado ser o usuario  estiver pesquisando
	$sql_2 = "SELECT id_usuario, nome, email
	FROM usuarios
	WHERE nome LIKE '%" . $busca . "%' 
	OR email LIKE '%" . $busca . "%' 
	ORDER BY nome ASC LIMIT " . $limite . " OFFSET " . $deslocamento . "";
		...
		<div id="conteudo">
			...
			<div id="corpo_conteudo">
				...
				<div id="topo_conteudo">
					<label id="titulo_conteudo">Usuários</label>


					<a href="usuarios_novo.php">
				...
				<div id="pesquisar-recipiente">
					...
					<button id="botao_pesquisar" onclick="window.location='usuarios.php?busca=' + document.getElementById('pesquisar').value"></button>
				</div>
						...
						<tbody>
							...
							?>
									<tr>
										...
										<td>
											<button id="botao_editar" onclick="window.location='usuarios_alterar.php?id=<?php echo $registro[0]; ?>'"></button>
