...
<head>
    ...
    <title>VF - Agenda - Físico</title>

    <meta charset="UTF-8">

    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link rel="stylesheet" type="text/css" href="css/agenda-fisico.css">
...
<body>
    ...
    <div class="fundo-banner">
        ...
        <div class="banner">
            ...
            <div class="agenda-borda">
                <div class="agenda">

                    <div class="imagem-destaque">

                        <img src="imagens/imagem-topo-agenda.png">
            ...
            <div class="detalhes-local">
                ...
                <div class="local">
                    ...
                    <p>
                        ...
                        <b>Hotel Intercity Pátio Pinda</b>

                        <object data="imagens/google-maps.svg" type="image/svg+xml"></object>
